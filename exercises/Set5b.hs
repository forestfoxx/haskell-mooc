...
walk (s:ss) Empty = Nothing
walk (s:ss) (Node _ l r) = case s of
    StepL -> walk ss l
    StepR -> walk ss r
------------------------------------------------------------------------------
...
set (s:ss) val Empty = Empty
set (s:ss) val (Node x l r) = case s of
    StepL -> Node x (set ss val l) r
    StepR -> Node x l (set ss val r)
------------------------------------------------------------------------------
